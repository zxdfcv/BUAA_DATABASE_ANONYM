...
const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'canteen', name: 'canteen', component: () => import('/@/views/admin/classification1.vue') },
      { path: 'classification', name: 'classification', component: () => import('/@/views/admin/classification2.vue') },
