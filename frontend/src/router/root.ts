...
const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'thing', name: 'thing', component: () => import('/@/views/admin/product.vue') },
      ...
      { path: 'canteen', name: 'canteen', component: () => import('/src/views/admin/classification1.vue') },
      { path: 'classification', name: 'classification', component: () => import('/src/views/admin/classification2.vue') },
