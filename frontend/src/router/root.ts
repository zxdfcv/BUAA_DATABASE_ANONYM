...
const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'classification', name: 'classification', component: () => import('/@/views/admin/classification1.vue') },
      { path: 'canteen', name: 'canteen', component: () => import('/@/views/admin/canteen.vue') },
