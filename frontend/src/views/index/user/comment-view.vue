            ...
            <div class="comment-item flex-view" v-for="item in commentData">
              ...
              <div class="infos">
                <div class="name flex-view">
                  <h3></h3>
                  <h3 v-if="item.title !== undefined" @click="handleClickTitle(item)">《{{item.title}}》</h3>
                  <h3 v-else-if="item.canteen_title !== undefined" @click="handleClickTitle(item)">《{{item.canteen_title}}》</h3>
                  <h3 v-else @click="handleClickTitle(item)">《{{item.classification_title}}》</h3>
                </div>
